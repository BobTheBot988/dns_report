...
\midrule
\textbf{S}trengths & No centralized operator logs; metadata privacy; AES-256-CTR encryption \cite{meshtastic_overview}. & \textbf{O}pportunities: High-privacy operational demand; growing need for off-grid communication. \\
\midrule
\textbf{W}eaknesses & Lower data rates; limited propagation range of LoRa \cite{meshtastic_overview}. & \textbf{T}hreats: Signal triangulation; future RF fingerprinting techniques. \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
